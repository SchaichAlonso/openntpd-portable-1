...
#cifuzz coverage ntpd_fuzzer_coverage --build-command "id" -v --format lcov --add-corpus /tmp/corpus

cifuzz coverage ntpd_fuzzer_coverage --build-command "id" -v --format lcov 
